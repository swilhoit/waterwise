...
import {
  ...
  ChevronRight, Lightbulb, Building2, MapPin
} from 'lucide-react'
      ...
      <div className="p-6">
        ...
        <div className="grid lg:grid-cols-2 gap-6 mb-6">
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-900">Gather required documents</p>
                    <p className="text-sm text-gray-600">
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-900">Install & schedule inspection</p>
                    <p className="text-sm text-gray-600">
          ...
          <div className="space-y-6">
            ...
            {(data.laundryToLandscapeAllowed !== undefined || data.branchedDrainAllowed !== undefined) && (
              <div>
                <h3 className="flex items-center gap-2 text-gray-900 font-semibold mb-4">
          ...
          <div className="bg-blue-50 rounded-xl p-4 border border-blue-200 mb-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-blue-700">{data.tips}</p>
              </div>
            </div>
          </div>
        )}
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pt-4 border-t border-gray-200">
          {hasDetailedData && data.departmentName ? (
            <div>
              ...
              <div className="flex flex-wrap gap-4 mt-2 ml-6">
                {data.departmentPhone && (
                  <a href={`tel:${data.departmentPhone}`} className="text-sm text-blue-600 hover:text-blue-700 flex items-center gap-1">
            ...
            <div>
              <p className="font-medium text-gray-900">Contact your local building department</p>
              <p className="text-sm text-gray-600">for specific permit requirements in {locationName}</p>
            </div>
          )}
